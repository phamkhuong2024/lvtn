                ...
                <form action="{{ route('admin.vouchers.store') }}" method="POST">
                        ...
                        <div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input @error('loai_khuyen_mai') is-invalid @enderror" 
                                       ...
                                       value="phan_tram" {{ old('loai_khuyen_mai') === 'phan_tram' ? 'checked' : '' }} required>
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input @error('loai_khuyen_mai') is-invalid @enderror" 
                                       ...
                                       value="so_tien" {{ old('loai_khuyen_mai') === 'so_tien' ? 'checked' : '' }} required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" min="0" 
                               ...
                               id="giatrigiam" name="giatrigiam" value="{{ old('giatrigiam') }}" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" min="0" 
                               ...
                               id="giatridonhang" name="giatridonhang" value="{{ old('giatridonhang') }}">
                        <small class="form-text text-muted">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control @error('ngaybatdau') is-invalid @enderror"
                               id="ngaybatdau" name="ngaybatdau" value="{{ old('ngaybatdau') }}" required>
                        @error('ngaybatdau')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control @error('ngayketthuc') is-invalid @enderror"
                               id="ngayketthuc" name="ngayketthuc" value="{{ old('ngayketthuc') }}" required>
                        @error('ngayketthuc')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="trangthai" 
                                   id="trangthai" value="1" {{ old('trangthai', true) ? 'checked' : '' }}>
