...
<div class="profile-container" style="max-width: 800px; margin: 40px auto; padding: 20px;">
    <div class="profile-header" style="margin-bottom: 30px;">
        <h1 style="font-size: 32px; font-weight: 700; margin-bottom: 10px;">Hồ sơ Admin</h1>
    ...
    <div class="profile-card" style="background: white; border-radius: 12px; box-shadow: 0 2px 12px rgba(0,0,0,0.1); padding: 30px; margin-bottom: 20px;">
        ...
        <form action="{{ route('admin.profile.update') }}" method="POST">
            ...
            <div class="form-group" style="margin-bottom: 20px;">
                <label for="tenad" style="display: block; font-weight: 500; margin-bottom: 8px; color: #333;">
                    Tên Admin <span style="color: red;">*</span>
                </label>
                <input 
                    type="text" 
                    id="tenad" 
                    name="tenad" 
                    value="{{ old('tenad', $admin->tenad) }}"
                    required
            ...
            <div style="display: flex; gap: 15px; margin-top: 30px;">
                <button 
                    type="submit" 
                    style="padding: 12px 32px; background: #007bff; color: white; border: none; border-radius: 8px; font-size: 16px; font-weight: 500; cursor: pointer; transition: background 0.3s;"
